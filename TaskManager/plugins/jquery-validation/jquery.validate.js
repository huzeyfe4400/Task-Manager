...
$.extend( $.validator, {
	...
	messages: {
		required: "*",
		remote: "Lütfen bu alanı sabitleyin.",
		...
		equalTo: "Lütfen aynısını tekrar girin.",
		maxlength: $.validator.format( "Bu alana en fazla {0} karakter girebilirsiniz." ),
		minlength: $.validator.format( "Lütfen en az {0} karakter giriniz." ),
		rangelength: $.validator.format( "Bu alana {0} ile {1} karakter uzunluğunda bilgi girilebilir." ),
